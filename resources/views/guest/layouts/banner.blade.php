<section id="home" class="container mx-auto py-36">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="overflow-hidden border rounded-3xl shadow-xl mx-12 md:mx-0 max-h-[350px]" data-aos="fade-left"
            data-aos-duration="1000">
            <img src="{{ asset('dist/assets/img/bg-yana.webp') }}" alt="" class="object-cover h-full w-full" />
        </div>
    </div>
</section>
